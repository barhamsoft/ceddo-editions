...
* @see https://v0.dev/t/REuBswN9F4y
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground text-lg">Découvrez le talent et l\'univers de nos auteurs.</p>
              </div>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <Card>
                  <CardHeader>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground text-lg">Retrouvez le calendrier de nos prochains événements.</p>
              </div>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <Card>
                  <CardHeader>
